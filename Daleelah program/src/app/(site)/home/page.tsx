      ...
      >
        <div style={{ maxWidth: 900 }}>
          <img
            src="/images/logo.png"
            alt="Daleelah"
            style={{ width: 100, height: 100, margin: "0 auto 20px", opacity: 0.9 }}
          />
      ...
      <section style={{ padding: "80px 20px", background: "rgba(0,108,53,0.03)" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 18, color: "var(--muted)", lineHeight: 2, marginBottom: 40 }}>
            ...
            المحليين والوجهات المميزة، ونوفر أدوات تخطيط رحلات مدعومة بالذكاء الاصطناعي.
          </p>
            ...
            {topDestinations.map((dest) => (
              ...
              >
                <div style={{ aspectRatio: "16/10", background: "#1a1a1a" }}>
                  <img src={dest.images[0]} alt={dest.title} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                <div style={{ padding: 18 }}>
                  <h3 style={{ margin: 0, fontSize: 20, fontWeight: 800, marginBottom: 8 }}>{dest.title}</h3>
                  <p style={{ margin: 0, color: "var(--muted)", fontSize: 14, marginBottom: 10 }}>{dest.summary}</p>
      ...
      <section style={{ padding: "80px 20px", background: "rgba(0,108,53,0.03)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: 40, textAlign: "center" }}>
            ...
            <p style={{ color: "var(--muted)", fontSize: 16 }}>مرشدون محليون خبراء</p>
          </div>
      ...
      <section style={{ padding: "100px 20px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "var(--muted)", fontSize: 18, lineHeight: 1.8, marginBottom: 30 }}>
            خطط لرحلتك الآن واستمتع بتجربة سياحية لا تُنسى
          </p>
